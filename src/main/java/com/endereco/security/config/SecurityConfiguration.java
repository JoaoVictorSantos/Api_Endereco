package com.endereco.security.config;

import com.endereco.security.JwtAuthenticationEntryPoint;
import com.endereco.security.JwtAuthenticationTokenFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler)
                ...
                .antMatchers("/auth/**", "/configuration/security", "/webjars/**", "/h2-console/**",
